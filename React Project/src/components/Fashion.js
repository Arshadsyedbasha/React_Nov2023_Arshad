...
export default function Fashion() {
  return (
    ...
    <div className='ar'>
    <Container>
        <p>Fashion, a realm where artistry meets identity, transcends mere fabric and stitches to become a language of self-expression. In this ever-evolving tapestry of style, each garment is a brushstroke painting the canvas of individuality. From the graceful dance of timeless classics to the bold steps of avant-garde creations, fashion speaks to the heart of cultural shifts and personal narratives. <br></br>
        It is a vibrant reflection of societal attitudes, a manifestation of creativity, and a celebration of diversity.
            <br></br> 
            Beyond the seams and hems, fashion is a kaleidoscope of colors, patterns, and textures that intertwine to create an immersive experience, weaving a narrative that is both personal and universal. As we adorn ourselves in the garments of our choosing, we participate in a living art form, shaping and reshaping the visual language of our shared human experience.
