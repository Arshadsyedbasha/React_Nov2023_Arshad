...
export default function Home2() {
  return (
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" color="transparent">
        <Toolbar>
          ...
          >
     <pre><b>Menu</b>                                          <i><b>Inventory Management System</b></i></pre>
          </Typography>
    ...
    <Container>
      <p><b>
An inventory management system is the backbone of efficient and streamlined business operations, providing a comprehensive solution to oversee and control the entire lifecycle of a company's inventory. 
It serves as a digital nerve center, seamlessly integrating with various departments to optimize inventory levels, reduce carrying costs, and enhance overall productivity. This sophisticated system leverages technology to 
track stock levels in real-time, automate reorder processes, and facilitate accurate forecasting, ensuring that businesses maintain optimal stock levels to meet customer demands while minimizing excess or obsolete inventory. With features ranging from barcode scanning 
and RFID technology to inventory analytics and reporting, these systems empower organizations to make informed decisions, improve supply chain efficiency, and ultimately contribute to increased profitability. In an era of heightened competition and dynamic market conditions, an effective inventory management system is 
not just a tool;
 it's a strategic asset that empowers businesses to stay agile, responsive, and ahead of the curve.</b></p>
